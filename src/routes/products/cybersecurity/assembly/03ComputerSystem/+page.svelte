<script>
    ...
    import lg008 from "$lib/img/products/cybersecurity/assembly/computerSystem/008.webp";
    import lg009 from "$lib/img/products/cybersecurity/assembly/computerSystem/009.webp";
    import lg010 from "$lib/img/products/cybersecurity/assembly/computerSystem/010.webp";
    import lg011 from "$lib/img/products/cybersecurity/assembly/computerSystem/011.webp";
    import lg012 from "$lib/img/products/cybersecurity/assembly/computerSystem/012.webp";
    import lg013 from "$lib/img/products/cybersecurity/assembly/computerSystem/013.webp";
    import lg014 from "$lib/img/products/cybersecurity/assembly/computerSystem/014.webp";
  ...
  {:else}
    ...
    <h1 class="text-center text-2xl font-extrabold my-4">Computer System</h1>
